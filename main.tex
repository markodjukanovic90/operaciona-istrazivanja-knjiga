...
\subsection{Problemi Modelovani preko Linearnog Programiranja}\label{sec:modeli_lp}
...
Upisivanje modela u .lp format se vrši pozivom funkcije \emph{writeLP()}, čiji je argument naziv fajla. 
 ...
 \end{verbatim}
 Optimalna vrijednost ove instance je 202.0 a dostiže se za vrijednost varijabli $x = (1, 0, 0)$, te $y_{11}= y_{12}= y_{13} = 1$, dok su ostale vrijenodsti 0.
