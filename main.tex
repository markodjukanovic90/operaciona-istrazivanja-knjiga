...
\font\myfont=cmr12 at 60pt
\clearpage
\title{\myfont Uvod u Operaciona Istraživanja}
\author{
...
\pagestyle{empty}
 \begin{tikzpicture}
 	\node (img) {\includegraphics[width=10.4cm, height=9.1cm]{Operations-Management4.png}};
...
\begin{titlepage}
	\centering
	\vfill
 \includegraphics[width=\textwidth]{Operations-Management5.jpg}
	{\bfseries{\huge
		Uvod u operaciona istraživanja}\\
		\vskip 1cm
...
Uvod u operaciona istraživanja
 ...
 \begin{figure}[h]
    \includegraphics[scale=0.5]{biblioteka.png}
\end{figure}
\clearpage
\pagenumbering{roman}
\chapter*{Predgovor}
...
\begin{figure}[!ht]
	...
	\begin{tikzpicture}[thick,scale=0.9, every node/.style={scale=0.9}]
	    ...
	    \draw[->](E.south)--+(0,-0.5)-|(H)node[left,near end]{\scriptsize $x_2 \geq 5$};
	\end{tikzpicture}
...
\end{tikzpicture}
    \caption{Drvo odlučivanja za rješavanje problema binarnog programiranja.}
