...
\end{equation}
 ...
 Primjer.%http://eaton.math.rpi.edu/faculty/Mitchell/courses/matp6640/notes/09C_egdcmpbeamer.pdf
...
Izabraćemo promjenljive $\lambda_1, s_1$ i $s_2$ kao inicijalne osnovne promjenljive. Pošto sada nemamo promjenljive $\lambda_2,\lambda_3$ i $\lambda_4$,  RMP izgleda ovako
      \begin{equation}
	...
	\end{aligned}
\end{equation}
Posljednji problem se trivijalno rješava (funkcija cilja ima vrijednost 0, a vrijednost promjenljivih se direktno očitavaju iz ograničenja).

Posmatrajmo sada dualni problem problema~\ref{primjer:dw3}. Označimo sa $y_1$, $y_2$ i $\alpha$ promjenljive dualnog problema.
