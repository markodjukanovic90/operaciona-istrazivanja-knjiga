...
$$  \sum_{j=1}^n x_{ij} = 1, \forall i =1,\ldots, n$$ 
 ...
 \section{Tehnike redukcije za ILP}
...
\end{enumerate}                                                       
 ...
 \chapter{Algoritamske tehnike za rješavanje Cjelobrojnog programiranja}
 ...
 \begin{enumerate}
     ...
     \item \emph{Tehnike otkidajućih ravni}.
...
U rješavanju problema  ILP-a, sljedeće jednostavne činjenice nam mogu biti od pomoći:
\begin{itemize}
...
Pozabavimo se sada \emph{Gomorijevim odsjecajućim ravnima}, generalnu metodu za dodavanje odsijecajućih ravni za  ILP.  Ideja je dobiti ove ravni iz nekog od ograničenja optimalne tabele simpleks metode koja predstavlja LP relaksaciju problema. Neka simpleks metod generiše sljedeći skup jednakosti u formi:

$$x_i + \sum_{ j} \overline{a}_{i,j} w_j= \overline{b}_i, i=1, \ldots,m$$
...
$$\begin{array}{cccc|c}
   ...
   -\frac{7}{5}                  & 0               &4 & 0 & 12
\end{array}$$
Dalje, biramo pivot element u datoj simpleks tabeli, a to je element $\overline{a}_{2,1} = \frac{14}{25}$, pa dobijemo simpleks tabelu
$$
\begin{array}{cccc|c}
...
\end{align*}
	\item Metodom gomorijevih odsijecajućih ravni, riješiti sljedeći ILP:% https://homepages.rpi.edu/~mitchj/handouts/gomorycuts/gomorycuts.html
	\begin{align*}
		 &\min -x_1 - x_2 \\
		 &s.t.\\
		 & 2 x_1 + 5x_2 \leq 20 \\
