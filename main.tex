...
Uputstvo. Definisati varijable odluke $x_{i,j}$ kao broj (tona) tereta $i$   (za $C_i, i=1, \ldots,4$,  respektivno) koji se skladišti  u odjeljak $j$, $j=1,2,3$ (prednji, središnji, stražnji).  % http://people.brunel.ac.uk/~mastjjb/jeb/or/lpmore.html 
