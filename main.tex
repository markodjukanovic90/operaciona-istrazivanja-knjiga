...
\section{Heurističke Metode}
 ...
 dobro'' i da se algoritam pokrenut na ulazni problem završava u realnom vremenu. Treba napomenuti da se pod  ``dovoljno
 ...
 Metaheuristika se formalno definiše kao iterativni proces koji koristi približne metode, kombinujući na inteligentan način različite koncepte za pretraživanje i iskorištenje čitavog prostora rješenja, da bi se u razumnom vremenu, na efikasan način, odredilo rješenje što bliže optimalnom.
 ...
 S obzirom na veliki broj raznih metaheuristika koje se razvijaju u posljednje vrijeme, prirodno je očekivati da se za  njihov razvoj koriste vrlo različiti pristupi, počev od polazne motivacije, preko strategije pretraživanja, različitih namjena i klasa problema na kojima se primjenjuju.
