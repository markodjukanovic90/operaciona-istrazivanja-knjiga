...
\begin{figure}[!ht]
	...
	\label{fig:step-2}
\end{figure}
Dalje, narednog pivota nalazimo u koloni 2 (koja odgovara varijabli $y$). Jedini kaddidat za pivota je element $\overline{a}_{3, 2}= 10$, pa nakon pivotiranja dobijamo tabelu 
...
-z  & 0    &  0    & 0    &   -\frac{21}{10} &-\frac{7}{10}  &  -18 \\ 
\end{array}
$$ 
kako ne postoje koordinate čiji su doprinosi pozitivni, našli smo optimum i on je jednak 
$(x,y)=(6,2)$. Ova tabela odgovara hodu od tačke $E=(2,0)$ do tačke $D=(6,2)$, kao na Slici~\ref{fig:step-3}.
