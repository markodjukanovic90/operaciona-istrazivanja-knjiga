...
%model konstruiran. 
Važno je još dokumentovati postupke koji se koriste u testiranju valjanosti modela. Ovo može  povećati povjerenje u model za buduće korisnike. Takođe, ako se u budućnosti pojave pitanja u vezi sa modelom, ova dokumentacijaće  biti korisna u dijagnosticiranju problema. 
