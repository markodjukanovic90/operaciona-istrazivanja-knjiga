...
Eksportovanje modela za moguće ponovno korištenje se može uraditi pozivom metoda \emph{exportModel}, čiji je argument naziv fajla (.lp ekstenzija).  
 ...
 pri tome izbjegavajući pojavljivanje specijalne sintakse gdje god je to moguće. PuLP je fokusirana na podršći modelovanju i rješavanju LP i MILP modelima. Interesantno je da PuLP 
