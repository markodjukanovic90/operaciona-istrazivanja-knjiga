...
\end{equation}
 ...
 \section{Kompleksnost rješavanja cjelobrojnog programiranja}\label{sec:kompleksnostILP}
   ...
   \begin{align*}
    ...
    \end{align*}    
gdje su $x2, \ldots, x_{n-2}$  proizvoljne bulove promjenjive.  
 ...
 Treba imati na umu da ove formule nisu logički ekvivalentne, ali su ekvivalentne u smislu zadovoljenja. 
   ...
   \begin{proof}
   	   ...
   	   Svaka klauzula $\phi_i(x)$ se pretvara u nejednakost na sljedeći način:
   	   \begin{itemize}
   	   	\item $z_i = x_i$, ako je $x_i$  literal u klauzuli $\phi$; 
 ...
 \begin{thm} Neka je $k\in \mathbb{Z}$.
 	 Problem odlučivanja da li postoji cjelobrojno rješenje  ILP-a,  vrijednosti manje od $k$ je NP--kompletan, posmatrajući ILP problem minimizacije. 
 \end{thm}
