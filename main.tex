...
\end{equation}
\end{definition}
Trebali bi naći tačku za koju je $L = 0$, odakle nalazimo optimalno rješenje (oba problema).  Uslovi za nalazak stacionarne tačku Lagranžijana $L$ su dati iz sistema
\begin{align}
...
interesantno je da parametar $\mu$ kontroliše udaljenost do opptimalnosti, tj. 
...
{
	   // works if the length of strings <= 5000
	   public:
