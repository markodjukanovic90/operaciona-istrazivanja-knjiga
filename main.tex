...
$$LB = \max\{LB,g^Ty+(u)^T(c-By)\}=\max\{1.045, 1055\} = 1055$$.
...
Rješavanjem ovog problema cjelobrojnog programiranja (na primjer, pomooću nekog od računarskih programa) dobija se optimalno rješenje za cjelobrojnu vrijednost $\overline{y}=41$, koje iznosi $\overline{z} = 1097.75$

Sada možemo da ažuriramo i gornju granicu, odnosno 

$$UB = \min\{1100,\overline{z}\} =  \min\{1100,1097.75\} =1097.75$$

Računamo razliku između gornje i donje granice

$$UB-LB=1097.75-1055 = 42.75$$
...
Računamo donju granicu, koja sada iznosi $1.045\cdot 500+540 = 1062.5$.
...
Dalje, master problemu pridružujemo odsjecajuću ravan
 ...
 Očigledno nam treba još jedna iteracija, pa ponovo formiramo dualni problem uzimajući $\overline{y}=250$.
