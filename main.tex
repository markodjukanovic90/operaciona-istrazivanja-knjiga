...
\fixme{marko, ovo razmatranje u narednom primjeru mi nije bas jasno, mozemo zajedno prodiskutovati. Marko: Detaljnije objasnjeno sada -- nadam se da je jasnije, pa pogledaj kako ti izgleda.}
...
\fixme{dovde sam stigao}
 ...
 Pohlepni algoritam za ovaj problem je dat u Algoritmu~\ref{alg:set-cover-gridi}.  %objasnjenje algoritma.
