...
\begin{proof}
        ...
        odakle imamo $c^T y = v$ i $c^T z = v$, dakle $y, z \in O^*$. Prema tome, $q^*$ nije ekstremna tačka od $O^*$. Dakle, imamo kontradikciju, odakle slijedi da je $q^*$  ekstremna tačka poliedra  $P$.
\end{proof}
