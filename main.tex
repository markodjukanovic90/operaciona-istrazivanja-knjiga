...
\end{itemize}
Tehnički zapisano, krećemo od \emph{restrikovanog master problema}
\begin{align*}
    &\min c^T x \\
    &\mbox{s.t} \\
    ...
    & x \geq 0. 
\end{align*}
kojeg riješimo, te izračunamo optimalno dualno rješenje. Sada je potrebno izgenerisati novu kolonu $A_j$ za koju je koeficijent doprinosa negativan, tj. $\overline{c_j} = c_j - c_B^T B^{-1}A_j < 0$.
