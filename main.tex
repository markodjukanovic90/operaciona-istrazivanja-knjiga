...
$$\begin{array}{ccccc|c}
    ...
    5 & 0 & -3 & 0 & 0 & -9 \\
\end{array}$$
\fxnote{Marko, ovdje je Milana primijetila da u prvoj koloni ima broj 7 koji je pozitivan. Kako onda nema elemenata koji su strogo veci od nule (njena primjedba oznacena crvenom bojom) Nisam dalje citao ovaj primjer, na ovo se moramo zajednicki vratiti. Marko: pogledacemo ovo, nisam siguran da razumijem konstataciju. Moram da vidim sta je Milana konkretno dodala kao primjedbu. Neke stvari su jos dodatno precizirane sada}
