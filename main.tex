...
\subsection{Heuristički Metodi}
 ...
 \noindent \textbf{Deklarisanje varijabli}. Ako zelimo da deklarisemo (realnu) varijablu $x$ gdje je $0 \leq x \leq 40$, koristimo klasu \emph{IloNumVar}, što odgovara sljedećoj liniji koda:
 \begin{verbatim}
...
Ako je potrebno implementirati varijablu za koju je $x \geq 0$ to radimo kao u prethodnom primjeru uz korištenje  \emph{IloInfinity} konstante.
 ...
 \noindent \textbf{Dodavanje ograničenja u model}. Ograničenja se direktno mogu dodati  u model sa funkcijom \emph{add}, dakle kao 
 ...
 \noindent \textbf{Metode za eksport rješenja (statistike) iz modela}. Metod \emph{getStatus} (koji se poziva na instancu klase \emph{IloCplex})  pokazuje da li je rješenje koje je nađeno dopustivo, ograničeno ili optimalno ili je CPLEX pokazao da je model nedopustiv ili neogranicen.
