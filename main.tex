...
Najčešće se prvo postavi lista zahtjeva koje dati model treba da ispuni, a rješenje koje zadovoljava te uslove najčešće se onda uzima kao prihvatljivo. OR pokušava da unese što je moguće više ``vrhunske nauke''  (tj. ispunjavanje nalazaska optimuma) u proces donošenja odluka. Međutim,  uslov da se u razumnom vremenskom roku dođe do modela koje vode ka rješenju koje je zadovoljavajuće najčešće ima prednost u odnosu na nalazak optimuma u nerazumnom vremenu. Tim, koji rukovodi procesom, razmatra troškove procesa razvoja modela, a zatim
