...
\begin{itemize}
    ...
    \item \emph{Simulacija}:  podrazumijeva izgradnju modela problema iz koga se dobijaju rješenja koja se provjeravaju prije nego se implementiraju u realnoj situaciji.
...
\end{itemize}
 ...
 Što se tiče   šire slike pojma Operaciona istraživanja, ovo nije trivijalno opisati. U osnovi, Operacona istraživanja su nauka o tome kako donijeti niz efikasnih odluka. Matematičko programiranje je jedna od najmoćnijih tehnika 
