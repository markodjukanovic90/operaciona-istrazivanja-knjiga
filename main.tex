...
Ako postoji jedinična podmatrica $I_m$ u gornjoj lijevoj blok matrici simpleks tabele, onda je jasno da je odgovor na prvo pitanje pozitivan. U primjeru~\ref{primjer:simpl1} su linearnom programu, koji sadrži ograničenja $Ax \leq b, x\geq 0$ pridodate izjednačavajuće promjenljive, kako bi se uslovi nejednakosti u ograničenjima transformirasali u potrebne jednakosti.  Na taj način je formirana i jedinična matrica, pa je i bazu jednostavno odrediti.
 ...
 \begin{align}
      ...
      &  x, \omega \geq 0. \nonumber
 \end{align}
\fxnote{Marko, je li umjesto omega treba s?}
...
% \section{Primjena dvofaznog simpleks metoda}     
 \fxnote{Marko, mislim da nema potrebe da ovo bude nova sekcija, pa sam samo prebacio u primjer okruzenje}
...
\fxnote{opet imamo omegu u nabrajanju}
\begin{itemize}
	\item posljednja vrsta dobija koeficijente originalne funkcije cilja razmatranog LP-a;
	\item kolone koje odgovaraju promjenljivima $\omega$ izbrišemo iz simpleks tabele;
...
\end{array}
$$ 
Kao što već pomenuto, izjednačavajuće varijable čine pogodne bazne promjenljive za početak simpleks metode, jer one formiraju jediničnu podmatricu u gornjoj blok matrici 
simpleks tabele. Prema tome, bazno rješenje je
$(x, y, s_1, s_2, s_3) = (0, 0, 3, 2, 26)$, koje je ujedno i dopustivo.
Na Slici~\ref{fig:step-1} je prikazan dopustivi region problema. Nakon prvog koraka, nalazimo u tački $A=(0,0)$, koja je dopustiva. Trenutna najbolja vrijednost je jednaka 0. 
\begin{figure}[H]
	\centering
...
\end{array}
$$ 
Ova tabela odgovara Slici~\ref{fig:step-2}. Prelazi se u bazno rješenje $(x,y, s_1, s_2, s_3)=(2, 0, 5, 0 ,20)$, odnosno do tačke $E=(2, 0)$. 
...
Kako ne postoje koordinate čiji su doprinosi pozitivni, našli smo optimum, koji se dostiže u tački $C=(2,5)$. Prethodna simpleks tabela odgovara Slici~\ref{fig:step-4}, dok svi koraci u simpleks metodi odgovaraju 
...
U slučaju da smo, u prvom koraku simpleks metode, umjesto promjenljive $x$ u bazu uključili promjenljivu $y$, do optimuma bismo došli pomjeranjem u tačku $B$, a potom u tačku $C$. U ovom slučaju bi bilo potrebno generisati samo dvije simpleks tabele (a ne tri, kao što smo mi imali u ovom primjeru).
\\
\section{Zadaci}
\begin{enumerate}
...
\begin{align*}
	 ...
	 & x_1, x_2 \geq 0.
\end{align*}
Da li se u nekom koraku simpleks metode javlja defenerativno bazno rješenje? Diskutovati zašto je ono degenerativno. 
