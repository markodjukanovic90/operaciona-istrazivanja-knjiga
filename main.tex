...
\begin{itemize}
    ...
    \end{itemize}
     ...
     \begin{itemize}
     	...
     	\item \emph{getMIPRelativeGap()}: vraća vrijednost relativne razdaljine (u procentima) između najboljeg dopustivog rješenja (nađenog od strane CPLEX-a) i dokazane gornje granice optmalnog rješenja.
     \end{itemize}
\end{itemize}
